...
public class chatActivity extends Activity implements OnItemClickListener ,OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chat_tt);  // jesse  �޸Ķ�Ӧ����
        mContext = this;
        init();
    }
	...
	private void init() {		   
		...
		sendButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				String msgText ="L"; // change sendstring jesse
				if (msgText.length()>0) {
					sendMessageHandle(msgText);	
					editMsgView.setText("");
					editMsgView.clearFocus();
		...
		sendButton= (Button)findViewById(R.id.back);
		sendButton.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
		...
		disconnectButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
		        if (Bluetooth.serviceOrCilent == Bluetooth.ServerOrClient.CILENT)
				{
		        	shutdownClient();
				}
				else if (Bluetooth.serviceOrCilent == Bluetooth.ServerOrClient.SERVICE)
				{
					shutdownServer();
				}
				Bluetooth.isOpen = false;
				Bluetooth.serviceOrCilent=Bluetooth.ServerOrClient.NONE;
				Toast.makeText(mContext, "发送内容不能为空", Toast.LENGTH_SHORT).show();
			}
		});		
	}    
